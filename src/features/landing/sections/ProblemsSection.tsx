...
export function ProblemsSection() {
  return (
    <section className="text-center">
      ...
      <div className="mt-16 grid grid-cols-2 justify-items-center gap-x-5 gap-y-5 md:grid-cols-2 md:gap-x-13.75 md:gap-y-[55px] lg:grid-cols-6">
